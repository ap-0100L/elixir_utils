  ...
  def is_not_empty(o, :binary) do
    result =
      if is_binary(o) do
        ...
        Macros.build_error_(:CODE_WRONG_VALUE_TYPE_ERROR, ["is not binary"])
      end
  ...
  def is_not_empty(o, :integer) do
    result =
      if is_integer(o) do
        ...
        Macros.build_error_(:CODE_WRONG_VALUE_TYPE_ERROR, ["is not integer"])
      end
  ...
  def is_not_empty(o, :atom) when not is_nil(o) do
    result =
      if is_atom(o) do
        ...
        Macros.build_error_(:CODE_WRONG_VALUE_TYPE_ERROR, ["is not atom"])
      end
  ...
  def is_not_empty(o, :boolean) do
    result =
      if is_boolean(o) do
        ...
        Macros.build_error_(:CODE_WRONG_VALUE_TYPE_ERROR, ["is not boolean"])
      end
